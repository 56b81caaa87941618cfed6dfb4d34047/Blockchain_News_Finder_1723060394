...
Vue.component("simple_header_component_1723060395", {
    template: `
        ...
        <nav id="nav-bar" class="bg-white border-gray-200 py-2.5 dark:bg-gray-900">
            <div id="nav-container" class="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
                ...
                <div id="menu-toggle-button" class="flex items-center lg:order-2">
                    ...
                    <button id="hello-world-button" class="inline-flex items-center p-2 ml-1 text-sm text-black rounded-lg hover:bg-purple-100 focus:outline-none focus:ring-2 focus:ring-purple-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" @click="sayHelloWorld">

                        <span class="sr-only">Hello World</span>
                        <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-11H9v4h2V7zm0 6H9v2h2v-2z" clip-rule="evenodd"></path>
                        </svg>
                    </button>
    ...
    // Start of sayHelloWorld method
    methods: {
        sayHelloWorld() {
            alert("Hello World");
        }
    }
    // End of sayHelloWorld method
